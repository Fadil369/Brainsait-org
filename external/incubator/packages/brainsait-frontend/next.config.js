...
const nextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_NOTIFICATION_URL: process.env.NEXT_PUBLIC_NOTIFICATION_URL || 'https://notifications.brainsait.org',
    NEXT_PUBLIC_WS_URL: process.env.NEXT_PUBLIC_WS_URL || 'wss://notifications.brainsait.org/ws',
