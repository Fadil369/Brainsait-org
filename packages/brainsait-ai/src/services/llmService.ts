...
export class LLMService {
  ...
  private async generateClaudeCompletion(request: LLMRequest): Promise<LLMResponse> {
    if (!this.anthropic) {
  ...
  async transcribeAndSummarize(transcription: string, context: any): Promise<any> {
