...
const getMentors = asyncHandler(async (req: any, res: any) => {
  res.status(200).json({
    success: true,
...
const createMentor = asyncHandler(async (req: any, res: any) => {
  res.status(201).json({
    success: true,
...
const getMentorById = asyncHandler(async (req: any, res: any) => {
  res.status(200).json({
    success: true,
