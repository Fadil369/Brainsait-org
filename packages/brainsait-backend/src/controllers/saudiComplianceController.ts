 ...
 */
export const createOrUpdateCompliance = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  if (!req.user) {
 ...
 */
export const getCompliance = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  if (!req.user) {
    return res.status(401).json({
      success: false,
      error: { message: 'Authentication required' }
 ...
 */
export const getComplianceSummary = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  if (!req.user) {
    return res.status(401).json({
      success: false,
      error: { message: 'Authentication required' }
 ...
 */
export const validateCR = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  if (!req.user) {
    return res.status(401).json({
      success: false,
      error: { message: 'Authentication required' }
 ...
 * Validate VAT Number
 */
export const validateVAT = asyncHandler(async (req: Request, res: Response) => {
 ...
 */
export const getComplianceStatistics = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
 ...
 */
export const triggerComplianceAudit = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  if (!req.user || !['ADMIN', 'SUPER_ADMIN'].includes(req.user.role)) {
    return res.status(403).json({
      success: false,
      error: { message: 'Admin privileges required' }
 ...
 */
export const getSaudiRegions = asyncHandler(async (req: Request, res: Response) => {
